<template>
  ...
  >
    <el-form ref="ruleForm" label-position="right" :rules="rules" label-width="80px" :model="formRole">
      ...
      <el-form-item label="块名称" prop="rootBlockName">
        <el-input v-model.trim="formRole.rootBlockName" placeholder="块名称" />
      </el-form-item>
    </el-form>
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        rootBlockName: [{ required: true, message: '请输入名称', trigger: 'blur' }]
      }
    }
  },
  watch: {
