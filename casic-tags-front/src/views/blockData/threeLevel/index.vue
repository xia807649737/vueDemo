      ...
      <div class="container">
        ...
        <div class="table">
          <div class="label-search">
            ...
            <span class="search-label">统计任务状态：</span>
            <el-input v-model="atomName" class="search-width230 margin-right15" size="small" />
          ...
          <el-table v-loading="loading" :data="tableData" height="calc(100vh - 340px)" style="width: 100%">
            ...
            <el-table-column prop="atomId" label="块ID" align="center" />
            <el-table-column prop="atomName" label="块名称" align="center" show-overflow-tooltip />
            <el-table-column prop="atomCallNum" label="子块数量" align="center">
              <template slot-scope="scope">
                <span>{{ scope.row.atomCallNum || 0 }}</span>
              </template>
            </el-table-column>
            <el-table-column prop="atomCallNum" label="标签数量" align="center">
              <template slot-scope="scope">
                <span>{{ scope.row.atomCallNum || 0 }}</span>
              </template>
            </el-table-column>
            <el-table-column prop="atomCallNum" label="人员数量" align="center">
              <template slot-scope="scope">
                <span>{{ scope.row.atomCallNum || 0 }}</span>
              </template>
            </el-table-column>
            <el-table-column prop="atomId" label="统计任务状态" align="center" />
