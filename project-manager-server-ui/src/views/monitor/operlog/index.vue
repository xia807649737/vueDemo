<template>
  <div class="app-container">
    ...
    <el-table ref="tables" v-loading="loading" :data="list" @selection-change="handleSelectionChange"
      ...
      <el-table-column label="操作人员" align="center" prop="operName" width="150" :show-overflow-tooltip="true"
      ...
      <el-table-column label="操作日期" align="center" prop="operTime" width="220" sortable="custom"
        :sort-orders="['descending', 'ascending']">
        <template slot-scope="scope">
          <span>{{ parseTime(scope.row.operTime) }}</span>
        </template>
      </el-table-column>
      <el-table-column label="消耗时间" align="center" prop="costTime" width="150" :show-overflow-tooltip="true"
        sortable="custom" :sort-orders="['descending', 'ascending']">
        <template slot-scope="scope">
