<template>
  <div class="app-container">
    ...
    <el-table ref="tables" v-loading="loading" :data="list" @selection-change="handleSelectionChange"
      ...
      <el-table-column label="用户名称" align="center" width="230" prop="userName" :show-overflow-tooltip="true"
        sortable="custom" :sort-orders="['descending', 'ascending']" />
      <el-table-column label="登录地址" align="center" prop="ipaddr" width="170" :show-overflow-tooltip="true" />
      <!-- <el-table-column label="登录地点" align="center" prop="loginLocation" width="150" :show-overflow-tooltip="true" /> -->
      <el-table-column label="浏览器" align="center" prop="browser" width="170" :show-overflow-tooltip="true" />
      <el-table-column label="操作系统" align="center" prop="os" width="170" />
      <el-table-column label="操作信息" align="center" prop="msg" width="170" :show-overflow-tooltip="true" />
      <el-table-column label="登录日期" align="center" prop="loginTime" sortable="custom"
        :sort-orders="['descending', 'ascending']" width="220">
        <template slot-scope="scope">
          <span>{{ parseTime(scope.row.loginTime) }}</span>
        </template>
      </el-table-column>
      <el-table-column label="登录状态" align="center" prop="status" fixed="right">
        <template slot-scope="scope">
    ...
    <el-pagination background @size-change="handleSizeChange" @current-change="handleCurrentChange"
      :current-page="queryParams.pageNum" :page-sizes="[10, 20, 30, 40, 50]" align=“right”
